function createDataset(fields, constraints, sortFields) {
  ...
  let baseQuery =
    "SELECT * FROM ( SELECT TRIM(RJ_FILIAL) AS RJ_FILIAL, TRIM(RJ_FUNCAO) AS RJ_FUNCAO, TRIM(RJ_DESC) AS RJ_DESC FROM SRJ010 A WHERE A.D_E_L_E_T_ <> '*' AND A.RJ_FILIAL <> ' ' AND UPPER(A.RJ_DESC) NOT LIKE '%TESTE%' ) WHERE ROWNUM <= 100";
