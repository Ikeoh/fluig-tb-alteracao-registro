function createDataset(fields, constraints, sortFields) {
   ...
   let baseQuery = "SELECT TRIM(A.PA_FILIAL) AS PA_FILIAL, TRIM(A.PA_CODIGO) AS PA_CODIGO, TRIM(A.PA_DESC) AS PA_DESC FROM SPA010 A WHERE A.D_E_L_E_T_ <> '*' ORDER BY A.PA_FILIAL";
