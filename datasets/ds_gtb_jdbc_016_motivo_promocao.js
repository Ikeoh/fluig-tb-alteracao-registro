function createDataset(fields, constraints, sortFields) {
   ...
   let baseQuery = "SELECT * FROM ( SELECT TRIM(A.X5_CHAVE) AS X5_CHAVE, TRIM(A.X5_DESCRI) AS X5_DESCRI FROM SX5010 A WHERE TRIM(A.X5_TABELA) = '41' AND A.D_E_L_E_T_ <> '*' ORDER BY TRIM(A.X5_DESCRI) ) WHERE ROWNUM <= 100";
