...
function enableFields(form) {
   ...
   var allFields = ["salarioAtual", "filial", "nomeFuncionario", "filialDestino", "centroCustoDestino", "cargoDestino", "salarioDestino", "codHorarioDestino", "tipoContratoDestino", "departamentoDestino", "justificativaVerificaRh", "btnAprovarVerificaRh", "btnReprovarVerificaRh", "btnAjustarVerificaRh", "justificativaGestorAtual", "btnAprovarGestorAtual", "btnReprovarGestorAtual", "btnAjustarGestorAtual", "justificativaGestorDestino", "btnAprovarGestorDestino", "btnReprovarGestorDestino", "btnAjustarGestorDestino", "justificativaPlanejContrOrc", "btnAprovarPlanejContrOrc", "btnReprovarPlanejContrOrc", "btnAjustarPlanejContrOrc", "justificativaDiretoria", "btnAprovarDiretor", "btnReprovarDiretor", "btnAjustarDiretor", "justificativaDiretorGrl", "btnAprovarDiretorGrl", "btnReprovarDiretorGrl", "btnAjustarDiretorGrl", "justificativaValidacaoRh", "btnAprovarValidacaoRh", "btnReprovarValidacaoRh", "btnAjustarValidacaoRh"];
   ...
   if (activity == ABERTURA || activity == AJUSTAR) {
      var fieldsToEnable = ["salarioAtual", "filial", "nomeFuncionario", "filialDestino", "centroCustoDestino", "cargoDestino", "salarioDestino", "codHorarioDestino", "tipoContratoDestino", "departamentoDestino"];
